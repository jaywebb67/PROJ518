...
from cProGAN import cProDiscriminator, cProGenerator,grow_schedule
...
save_path    = os.path.join("GANs", "cProGAN", "cProGAN-checkpoint",f"{g}")
if not os.path.exists(save_path):
    os.makedirs(save_path)

# Create folder to hold result
result_folder = os.path.join("GANs", "cProGAN", "cProGAN-result",f"{g}")
